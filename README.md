...
fix needed, this just self-heals the next time you deploy. There's also now a
**Settings → Backups → 🔧 Repair Database Schema** button if you ever want to trigger
this manually without waiting for a redeploy.
