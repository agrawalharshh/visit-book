...
function runMigrations(wrapper) {
  ...
  // Any user created by an earlier version of this app has role='staff', which
  // isn't one of the 5 real roles and would silently fall through to zero
  // permissions under the new system. Map it to 'data_entry' (the closest
  // equivalent to the old behavior) rather than leaving them locked out.
