...
async function initDb() {
  ...
  if (url && token) {
    ...
    console.log('⚠️  No Turso credentials — using /tmp (resets on restart)');
...
async function initSchema() {
  // Use CURRENT_TIMESTAMP (works on both Turso cloud and SQLite)
  const tables = [
    ...
    `CREATE TABLE IF NOT EXISTS entries (
      id TEXT PRIMARY KEY,
      date TEXT, visit TEXT DEFAULT 'No',
      company TEXT, client TEXT, client2 TEXT,
      phone TEXT, phone2 TEXT,
      address TEXT, remarks TEXT,
      followup TEXT, followup2 TEXT,
      converted TEXT DEFAULT 'No', converted_by TEXT,
      sample TEXT DEFAULT 'No',
      grade TEXT, agent TEXT,
    ...
    `CREATE TABLE IF NOT EXISTS clients (
      id TEXT PRIMARY KEY,
      company TEXT NOT NULL, client TEXT,
      phone TEXT, address TEXT, notes TEXT,
      grade TEXT, assigned_to TEXT,
      source TEXT DEFAULT 'manual',
      entry_id TEXT, orders TEXT DEFAULT '[]',
      created_at TEXT DEFAULT CURRENT_TIMESTAMP,
      updated_at TEXT DEFAULT CURRENT_TIMESTAMP
    )`,
    `CREATE TABLE IF NOT EXISTS meetings (
      id TEXT PRIMARY KEY,
      date TEXT, time TEXT,
      company TEXT, client TEXT, phone TEXT,
    ...
    `CREATE TABLE IF NOT EXISTS wa_log (
      ...
      company TEXT, client TEXT, phone TEXT,
      type TEXT, status TEXT DEFAULT 'sent',
  ...
  try {
    ...
    const count = parseInt(row?.c ?? row?.[0] ?? 0);
    if (count === 0) {
